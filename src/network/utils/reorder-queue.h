...
class ReorderQueue : public Queue<Item, Container>
{
public:
  /**
...
private:
  ...
  using Queue<Item, Container>::Head;
  using Queue<Item, Container>::Tail;
  using Queue<Item, Container>::DoEnqueue;
  using Queue<Item, Container>::DoDequeue;
  using Queue<Item, Container>::DoRemove;
  using Queue<Item, Container>::DoPeek;
  using Queue<Item, Container>::DropBeforeEnqueue;
